...
public class RestaurantRepositoryServiceTest {
  ...
  // @Test
  // void findRestaurantsByAttribute(@Autowired MongoTemplate mongoTemplate){
  //   assertNotNull(mongoTemplate);
  //   assertNotNull(restaurantRepositoryService);
  //   // System.out.println(allRestaurants);
  //   List<Restaurant> restaurants = restaurantRepositoryService.findRestaurantsByAttributes(20.8, 30.1, "Tamil", LocalTime.of(18,45), 5.0);
